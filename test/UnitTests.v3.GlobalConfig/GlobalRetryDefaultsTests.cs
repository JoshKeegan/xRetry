...
namespace UnitTests.v3.GlobalConfig
{
    public class GlobalRetryDefaultsTests
    {
        ...
        private static readonly ConcurrentDictionary<int, int> explicitTheoryRetryCounts = new();
        private static readonly ConcurrentDictionary<int, Stopwatch> theoryConfiguredDelayStopwatches = new();
        private static readonly ConcurrentDictionary<int, Stopwatch> theoryExplicitMaxConfiguredDelayStopwatches = new();
        private static readonly ConcurrentDictionary<int, Stopwatch> theoryExplicitDelayPropertyStopwatches = new();
        private static readonly ConcurrentDictionary<int, Stopwatch> theoryExplicitDelayStopwatches = new();
        ...
        {
            explicitMaxConfiguredDelayStopwatch ??= Stopwatch.StartNew();
        ...
        {
            explicitDelayPropertyStopwatch ??= Stopwatch.StartNew();
