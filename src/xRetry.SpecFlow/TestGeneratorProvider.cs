...
namespace xRetry.SpecFlow
{
    public class TestGeneratorProvider : XUnit2TestGeneratorProvider
    {
        ...
        private const string RETRY_UNTAGGED_FACT_ATTRIBUTE = "xRetry.SpecFlow.RetryUntaggedFact";
        private const string RETRY_UNTAGGED_THEORY_ATTRIBUTE = "xRetry.SpecFlow.RetryUntaggedTheory";
        ...
        {
            // SpecFlow.xUnit implements dynamic skipping by throwing Xunit.SkipException. Treat it as a skip rather
