...
{
    // TODO: Remove once SetTestMethod is virtual in SpecFlow release
    public class CustomXUnit2TestGeneratorProvider : IUnitTestGeneratorProvider
    {
        ...
        public CustomXUnit2TestGeneratorProvider(CodeDomHelper codeDomHelper, ProjectSettings projectSettings)
        {
